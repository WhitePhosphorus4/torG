...
from comp.GCN_model import GCN
...
parser.add_argument('--model', type=str, default="GCN", help='choose the version of GAT.')
parser.add_argument('--iskernel', action='store_true', default=False, help='Run in kernel-attention')
parser.add_argument('--kernel', type=str, default='polynomial', help='Choose the kernel function')
