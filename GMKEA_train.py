...
from comp.GMKEA_model import GMKEA
...
parser.add_argument('--model', type=str, default="GMKEA", help='choose the version of GAT.')
...
if args.dataset == 'cora':
    ...
    adj, features, labels, idx_train, idx_val, idx_test = load_txt_data(num_points=2000, data_name="sptest")   
...
if args.model == "GMKEA":
    model = GMKEA(nfeat=features.shape[1], 
                nhid=args.hidden, 
